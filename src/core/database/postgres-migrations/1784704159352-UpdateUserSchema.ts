...
export class UpdateUserSchema1784704159352 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."tenants_plan_enum" AS ENUM('free', 'pro', 'enterprise')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "first_name" character varying(20)`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "last_name" character varying(20)`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_workspace_role_enum" AS ENUM('owner', 'admin', 'member', 'viewer')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "workspace_role" "public"."users_workspace_role_enum" NOT NULL DEFAULT 'member'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e9f4c2efab52114c4e99e28efb" ON "users" USING btree ("email", "tenant_id") `,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_userrole_enum" AS ENUM('admin', 'user')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "userRole" "public"."users_userrole_enum" NOT NULL DEFAULT 'user'`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "isEmailVerified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "lastName" character varying(20)`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "firstName" character varying(20)`,
    );
    await queryRunner.query(
